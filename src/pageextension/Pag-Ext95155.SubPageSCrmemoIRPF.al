/// <summary>
/// PageExtension SubPageSCrmemoIRPF (ID 92160) extends Record Posted Sales Cr. Memo Subform.
/// </summary>
Pageextension 95155 SubPageSCrmemoIRPF extends "Posted Sales Cr. Memo Subform"
{
    ...
    VAR
        TotalPurchCrMemoHdr: Record 114;
    ...
    BEGIN
        ...
        DocumentTotals.CalculatePostedSalesCreditMemoTotals(TotalPurchCrMemoHdr, VATAmount, Rec);
        // EC-JRJOFRE
...
/// </summary>
pageextension 95170 PstSalesCrMempIrpf extends "Posted Sales Credit Memo"
{
    ...
    begin
        if (Rec."Código grupo retención (BE)" <> '') then begin
            CurrPage.SalesCrMemoLines.Page.MostrarRetenciones(true, false);
        end;
        if (Rec."Código grupo retención (IRPF)" <> '') then begin
            CurrPage.SalesCrMemoLines.Page.MostrarRetenciones(false, true);
        end;
    end;
}