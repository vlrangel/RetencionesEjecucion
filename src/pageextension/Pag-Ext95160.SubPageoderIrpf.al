/// <summary>
/// PageExtension SubPageInvoiceIrpf (ID 92156) extends Record Sales Cr. Memo Subform.
/// </summary>
Pageextension 95160 SubPageoderIrpf extends "Sales Order Subform"
{
    ...
    layout
    {
        addbefore("Line Amount")
        {
            ...
            // field("% retención (BE)"; Rec."% retención (BE)") { ApplicationArea = All; }


            // field("Importe retención (BE)"; Rec."Importe retención (BE)") { ApplicationArea = All; }
        ...
        addafter(Control28)
        {
            group(Irpf)
            {
                ...
                field("Tot Contrato"; TotalSalesLine."Amount Including VAT" - TotalInvoiceHdr."Importe retención (IRPF)")
                {
                    ApplicationArea = All;
            ...
            group(Be)
            {
                ...
                field("Tota Contrato"; TotalSalesLine."Amount Including VAT" - TotalInvoiceHdr."Importe retención (IRPF)")
                {
                    ApplicationArea = All;
